...
def test_pointing_from_independent_observed_sky(tmp_path, hour, latitude, altitude, heading):
    ...
    initial = dict(zip(KEYS, PARAMS), LENS_ALTITUDE=seed_altitude, PRECESSION=True)
